        ...
        <div className="bg-white rounded-xl shadow-lg p-4 md:p-6 mb-6 md:mb-8">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
            <div>
              ...
              <p className="text-gray-600 text-sm md:text-base">{order.canteen_id}</p>
            </div>
          ...
          <div className="p-8 md:p-12 text-center">
            <div className="inline-block mb-6">
              <div 
                ...
                style={{ backgroundColor: `${steps[currentStepIndex]?.color || '#831615'}15` }}
              >
                <StepIcon 
                  size={80} 
                  className="md:w-24 md:h-24"
                  style={{ color: steps[currentStepIndex]?.color || '#831615' }} 
                />
              </div>
            </div>
            ...
            <p className="text-gray-600 text-base md:text-lg mb-8">
              {steps[currentStepIndex]?.description || 'The canteen is carefully preparing your delicious meal'}
            </p>
          </div>
